...
(function () {
  ...
  */
  ...
  var prototypeAccessors$c = { isMuted: { configurable: true },status: { configurable: true },name: { configurable: true },labels: { configurable: true },reference: { configurable: true },parameters: { configurable: true },isRatingActive: { configurable: true },_base: { configurable: true } };

  prototypeAccessors$c.isMuted.get = function () {
    return this._isMuted;
  };

  prototypeAccessors$c.isMuted.set = function (value) {
    this._isMuted = value;
  };

  prototypeAccessors$c.status.get = function () {
    return this._status;
  };

  prototypeAccessors$c.name.get = function () {
    return this._name;
  };

  prototypeAccessors$c.labels.get = function () {
    return this._labels;
  };

  prototypeAccessors$c.reference.get = function () {
    return this._reference;
  };

  prototypeAccessors$c.parameters.get = function () {
  ...
  prototypeAccessors$c.isRatingActive.get = function () {
    return this._isRatingActive;
  };

  prototypeAccessors$c.isRatingActive.set = function (value) {
  ...
  prototypeAccessors$c.reference.set = function (value) {
    var valid = validateString(value, ("action " + (this._name)));
    if (valid !== null) { this._reference = valid; }
  };

  prototypeAccessors$c._base.get = function () {
  ...
  Action.prototype.start = function start (data) {
    ...
    var layer = this._getLayer(mode, data);
    return layer;
  };
  ...
  Object.defineProperties( Action.prototype, prototypeAccessors$c );
  ...
  Queue.prototype.collect = function collect (layer) {
    this._type = PushType.COLLECTOR;
    this._collectionLayer = layer;
    this._request();
  };

  Queue.prototype.appendStartingAction = function appendStartingAction (action) {
  ...
  Queue.prototype.appendEndingAction = function appendEndingAction (action) {
  ...
  Queue.prototype.send = function send (ending) {
    ...
    var actionLayers = [];
    if (!ending) { actionLayers.push.apply(actionLayers, this._startingActions.map(function (action) { return action.start(); }).filter(function (layer) { return layer.length > 0; })); }
    actionLayers.push.apply(actionLayers, this._endingActions.map(function (action) { return action.end(); }).filter(function (layer) { return layer.length > 0; }));
    ...
    push(this._type, ( this._collectionLayer ).concat( slices[0]));

    if (slices.length > 1) {
      for (var i$1 = 1; i$1 < slices.length; i$1++) {
        push(PushType.ACTION, slices[i$1]);
      }
    }
  ...
  ActionElement.prototype.begin = function begin () {
  ...
  var Actionee = /*@__PURE__*/(function (superclass) {
    ...
    var prototypeAccessors = { proxy: { configurable: true },isMuted: { configurable: true },priority: { configurable: true },isInteractive: { configurable: true },actionElement: { configurable: true },label: { configurable: true },isActionee: { configurable: true },level: { configurable: true },type: { configurable: true } };
  ...
  var ComponentActionee = /*@__PURE__*/(function (Actionee) {
    ...
    ComponentActionee.prototype.listenInputValidation = function listenInputValidation (node, type) {
  ...
  var UploadActionee = /*@__PURE__*/(function (ComponentActionee) {
    ...
    UploadActionee.prototype.getData = function getData () {
  ...
  api.analytics.readiness.then(function () { return integration(); });
